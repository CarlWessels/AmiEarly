...
BEGIN
	...
	*/
	...
	SET @Result = @Result + '-- <auto-generated>' + @EOL
	SET @Result = @Result + '--     This code was generated by a tool.' + @EOL
	SET @Result = @Result + '--' + @EOL
	SET @Result = @Result + '--     Changes to this file may cause incorrect behavior and will be lost if' + @EOL
	SET @Result = @Result + '--     the code is regenerated.' + @EOL
	SET @Result = @Result + '-- </auto-generated>' + @EOL
	SET @Result = @Result + '--------------------------------------------------------------------------------' + @EOL
	...
	SET @Result = @Result + '' + @EOL
	SET @Result = @Result + '	DECLARE @UpdatePermissionGUID UNIQUEIDENTIFIER = (SELECT GUID FROM LUPermission WHERE Permission = ''' + @TableName + 'Update'')' + @EOL
	SET @Result = @Result + '	DECLARE @InsertPermissionGUID UNIQUEIDENTIFIER = (SELECT GUID FROM LUPermission WHERE Permission = ''' + @TableName + 'Insert'')' + @EOL
	...
	SET @Result = @Result + '		BEGIN' + @EOL
    SET @Result = @Result + '			THROW 51000, ''The user does not have permission to INSERT into ' + @TableName + ''', 1;  '+ @EOL
	SET @Result = @Result + '		END' + @EOL
	...
	SET @Result = @Result + '		BEGIN' + @EOL
    SET @Result = @Result + '			THROW 51000, ''The user does not have permission to UPDATE ' + @TableName + ''', 1;  '+ @EOL
	SET @Result = @Result + '		END' + @EOL
	...
	SET @Result = @Result + '	END' + @EOL
	SET @Result = @Result + '	EXEC [spRefreshTokenNoReturn] @SystemUserGUID' + @EOL
	SET @Result = @Result + '	DECLARE @GetPermissionGUID UNIQUEIDENTIFIER = (SELECT GUID FROM LUPermission WHERE Permission = ''' + @TableName + 'Get'')' + @EOL
	SET @Result = @Result + '	DECLARE @GetAllPermissionGUID UNIQUEIDENTIFIER = (SELECT GUID FROM LUPermission  WHERE Permission = ''' + @TableName + 'GetAll'')' + @EOL
	...
	SET @Result = @Result + '		BEGIN' + @EOL
    SET @Result = @Result + '			THROW 51000, ''The user does not have permission to GETALL from ' + @TableName + ''', 1;  '+ @EOL
	SET @Result = @Result + '		END' + @EOL
	SET @Result = @Result + '		ELSE' + @EOL
	SET @Result = @Result + '		BEGIN' + @EOL
	SET @Result = @Result + '			SELECT *' + @EOL
	...
	SET @Result = @Result + '		BEGIN' + @EOL
    SET @Result = @Result + '			THROW 51000, ''The user does not have permission to GET from ' + @TableName + ''', 1;  '+ @EOL
	SET @Result = @Result + '		END' + @EOL
	SET @Result = @Result + '		ELSE' + @EOL
	SET @Result = @Result + '		BEGIN' + @EOL
	SET @Result = @Result + '			SELECT *' + @EOL
